...
// Import the CybersourceCheckout component at the top of the file
import CybersourceCheckout from "@/components/cybersource-checkout"
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <CybersourceCheckout customerData={formData} />
            </form>
          </div>
        </div>
